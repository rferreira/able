 ...
 * </pre>
 */
public class XSendFileHandler extends SimpleChannelHandler {
    ...
    public XSendFileHandler() {
        LOG.info("xsendfile support enabled");
    }
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        ...
        final String path = request.getHeader(XHeaders.X_SENDFILE);
        if (path == null) {
